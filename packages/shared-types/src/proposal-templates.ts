...
export const DEFAULT_PROPOSAL_TEMPLATE_CONFIG: ProposalTemplateConfig = {
  ...
  sections: [
    ...
    { key: "gallery", enabled: false, position: 8, title: "Galeria" },
    { key: "economy_purchases", enabled: false, position: 9, title: "Economia — poder de compra" },
    { key: "pricing", enabled: true, position: 10, title: "Investimento" },
    { key: "financing", enabled: false, position: 11, title: "Financiamento" },
    { key: "testimonials", enabled: false, position: 12, title: "Depoimentos" },
    { key: "social_proof", enabled: false, position: 13, title: "Prova Social" },
    {
      key: "guarantees",
      enabled: false,
      position: 14,
    ...
    { key: "faq", enabled: false, position: 16, title: "Perguntas Frequentes" },
    { key: "cta", enabled: false, position: 17, title: "Chamada para Acao" },
    { key: "signature", enabled: false, position: 18, title: "Assinatura" },
    { key: "comparison", enabled: false, position: 19, title: "Comparativo" },
    { key: "video", enabled: false, position: 20, title: "Video" },
