  ...
  return (
    ...
    >
      ...
      <div className="relative h-[390px] sm:h-[425px] w-full overflow-hidden bg-[#03060c] p-2.5 sm:p-3 pb-16 sm:pb-20">
        ...
        <div className="pointer-events-none absolute inset-0 rounded-3xl shadow-[inset_0_0_0_1px_rgba(255,255,255,0.05)] group-hover:shadow-[inset_0_0_20px_rgba(16,185,129,0.12)] transition-shadow duration-500" />
      </div>
      ...
      <div className="pointer-events-none absolute bottom-0 left-0 w-full p-5 sm:p-6 z-30 bg-gradient-to-t from-[#040711] via-[#040711]/90 to-transparent flex items-end justify-between">
        <div>
          <div className="flex items-center gap-2 mb-1">
            <div className="flex h-6 w-6 items-center justify-center rounded-lg bg-white/10 text-emerald-400">
          ...
          <h3 className="text-xl font-bold text-white sm:text-2xl group-hover:text-emerald-200 transition-colors">
            {panel.title}
          </h3>
        </div>
