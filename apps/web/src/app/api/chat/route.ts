...
- SEMPRE utilize DUAS quebras de linha (parágrafos duplos) ou a tag `< br > <br>` para separar cada linha de informação. Se você não pular linha DUAS vezes, o sistema vai renderizar tudo colado de forma ilegível.
